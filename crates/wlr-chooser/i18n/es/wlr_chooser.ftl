...
daemon-not-running = No hay ningún demonio wlr-overlayd en ejecución, así que esta superposición paga todo el arranque (unos 90 ms). Inicia uno desde el autoarranque de tu sesión: `wlr-overlayd`.
