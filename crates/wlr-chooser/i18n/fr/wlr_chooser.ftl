...
daemon-not-running = Aucun démon wlr-overlayd ne tourne : cet overlay paie donc tout le démarrage (environ 90 ms). Lancez-en un depuis l'autostart de votre session : `wlr-overlayd`.
