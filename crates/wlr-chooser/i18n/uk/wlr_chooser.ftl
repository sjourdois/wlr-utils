...
hold-no-modifier = Режим утримання ввімкнено: перемикач перемикає, щойно не утримується жодна клавіша Alt чи Super, — одразу й нічого не показавши, якщо під час відкриття жодна не утримується. Передайте --no-hold, щоб оверлей лишався відкритим.
