...
daemon-not-running = Er draait geen wlr-overlayd-daemon, dus deze overlay betaalt de volledige opstart (ongeveer 90 ms). Start er een vanuit de autostart van je sessie: `wlr-overlayd`.
