...
daemon-not-running = Żaden demon wlr-overlayd nie działa, więc ta nakładka płaci pełny koszt uruchomienia (około 90 ms). Uruchom go z autostartu sesji: `wlr-overlayd`.
