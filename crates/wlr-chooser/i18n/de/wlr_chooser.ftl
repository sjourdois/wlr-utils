...
daemon-not-running = Es läuft kein wlr-overlayd-Daemon, daher zahlt dieses Overlay den vollen Start (etwa 90 ms). Starte einen aus dem Autostart deiner Sitzung: `wlr-overlayd`.
