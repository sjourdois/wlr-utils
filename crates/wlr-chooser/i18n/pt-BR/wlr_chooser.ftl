...
daemon-not-running = Nenhum daemon wlr-overlayd está em execução, então esta sobreposição paga toda a inicialização (cerca de 90 ms). Inicie um pela inicialização automática da sua sessão: `wlr-overlayd`.
