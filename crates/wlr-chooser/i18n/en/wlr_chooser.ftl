...
daemon-not-running = No wlr-overlayd daemon is running, so this overlay pays the full startup (about 90 ms). Start one from your session autostart: `wlr-overlayd`.
